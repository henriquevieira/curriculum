...
\programming{{HTML5 $\textbullet$ JS  $\textbullet$ Python / 3}, {Shell Script $\textbullet$ SQL $\textbullet$ \large \LaTeX / 3.5}, {R $\textbullet$ Java $\textbullet$ Perl / 5}}
...
\cvsite{enrikevieira.com} % Personal website
